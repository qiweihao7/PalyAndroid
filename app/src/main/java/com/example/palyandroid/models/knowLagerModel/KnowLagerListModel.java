package com.example.palyandroid.models.knowLagerModel;
...
public class KnowLagerListModel extends BaseModel {
    public void getKnowLagerListData(int page, Map<String, Object> map, final CallBack callBack) {
        ...
        Observable<String> data = myServer.getKnowLagerListData(page, map);
