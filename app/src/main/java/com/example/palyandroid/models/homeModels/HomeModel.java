package com.example.palyandroid.models.homeModels;
...
public class HomeModel extends BaseModel{
    public void getAlertListData(int page, Map<String, Object> map, final CallBack callBack) {
        ...
        Observable<String> data = myServer.getHomeListData(page, map);
    ...
    public void getBannerData(String url, Map<String, Object> map, final CallBack callBack) {
        Retrofit retrofit = new Retrofit.Builder()
                .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
                .addConverterFactory(ScalarsConverterFactory.create())
                .baseUrl(MyServer.URL)
