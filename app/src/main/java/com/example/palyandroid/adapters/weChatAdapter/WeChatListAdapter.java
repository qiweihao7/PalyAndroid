...
public class WeChatListAdapter extends RecyclerView.Adapter {
    ...
    public List<WeChatListBean.DataBean.DatasBean> list;
    private OnItemClickListener mListener;

    public WeChatListAdapter(Context context, List<WeChatListBean.DataBean.DatasBean> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_wechat_home, null);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        holder1.all.setText(list.get(position).getAuthor()+"/"+list.get(position).getSuperChapterName());
    ...
    public void setList(List<WeChatListBean.DataBean.DatasBean> list) {
        this.list = list;
